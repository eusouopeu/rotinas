...
export default defineConfig({
  testDir: aqui,
  testMatch: ["telas.spec.mjs", "catalogo.spec.mjs", "ajustes.spec.mjs", "notas.spec.mjs", "metas.spec.mjs", "dados.spec.mjs", "boletim.spec.mjs", "rotinas.spec.mjs", "editor.spec.mjs"],
